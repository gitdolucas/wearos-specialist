...
## Checklist (docs / Wear OS alignment)

When your PR touches guidance or examples, confirm:

- [ ] **Product constraints**: Primary flow remains watch-appropriate; no new precision-typing or blocking flows (unless explicitly called out).
